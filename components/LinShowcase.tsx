             ...
             <div className="flex flex-col gap-3">
               ...
               >
                 <div className="bg-white/10 p-5 rounded-3xl backdrop-blur-xl border border-white/20 mt-1 shadow-2xl flex flex-col gap-3">
                   ...
                   <input required name="name" placeholder="الاسم الكامل" className="bg-white/5 border border-white/20 rounded-xl px-4 py-2.5 text-[15px] text-white placeholder-[#8a7a68] focus:outline-none focus:border-white/50 transition-colors" />
                   <input required type="tel" name="phone" placeholder="رقم الهاتف" className="bg-white/5 border border-white/20 rounded-xl px-4 py-2.5 text-[15px] text-white placeholder-[#8a7a68] focus:outline-none focus:border-white/50 transition-colors text-right" dir="ltr" />
                   <div className="flex flex-col gap-2">
                     <select 
                       required 
        ...
        <div className="relative">
          <AnimatePresence mode="wait">
              ...
              >
                ...
                <input required name="name" placeholder="الاسم الكامل" className="bg-white/5 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-[#8a7a68] focus:outline-none focus:border-white/50 transition-colors text-base relative z-10" />
                <input required type="tel" name="phone" placeholder="رقم الهاتف" className="bg-white/5 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-[#8a7a68] focus:outline-none focus:border-white/50 transition-colors text-right text-base relative z-10" dir="ltr" />

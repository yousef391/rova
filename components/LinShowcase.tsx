        ...
        <div className="flex flex-col flex-1 justify-between gap-4 mt-1">
           ...
           <div className="flex justify-between items-start z-30">
             ...
             <AnimatePresence mode="wait">
                ...
                >
                  {selectedQuantity === 2 && (
                    <span className="text-white/50 text-[0.85rem] line-through" style={{ fontFamily: "var(--font-dm)" }}>{(singlePrice * 2).toLocaleString()} DA</span>
                  )}
      ...
      <div className="hidden lg:flex absolute bottom-0 left-0 right-0 z-20 items-end justify-between px-10 pb-8">
        ...
        <div className="flex flex-col items-center gap-3">
          <AnimatePresence mode="wait">
            ...
            >
              {selectedQuantity === 2 && (
                <span className="text-white/50 text-sm line-through" style={{ fontFamily: "var(--font-dm)" }}>{(singlePrice * 2).toLocaleString()} DA</span>
              )}

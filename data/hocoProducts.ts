...
export const hocoProducts: HocoProduct[] = [
  {
    ...
    battery: "CR2032 تدوم عام كامل (قابل للاستبدال)",
    features: [
      {
        icon: "📍",
      ...
      {
        icon: "🛡️",
        title: "تشفير تام وحماية للخصوصية",
        desc: "لا أحد يمكنه الاطلاع على موقع جهازك سواك، مع ميزة التنبيه التلقائي ضد التتبع."
      }
    ]
  }
];
...
export const customerReviews = [
  ...
  },
  {
    ...
    rating: 5,
    date: "منذ 3 أيام",
    comment: "اشتريت عرض القطعتين (واحدة للآيفون وواحدة لأخي أندرويد). الجودة ممتازة والصوت تع الرنين مسموع بزاف. ما تحتاج شريحة ما تحتاج تخلص كل شهر. 10/10."
  },
  {
    name: "حمزة ق.",
    city: "قسنطينة",
    rating: 5,
    date: "منذ 5 أيام",
    comment: "خدمة التوصيل كانت سريعة جداً وصلني لسطيف في يومين. ركبتو فمفاتيح الطوموبيل والساكوشة، هناني من الضياع."
  },
  {
    name: "سفيان ت.",
    city: "البليدة",
    rating: 5,
    date: "منذ أسبوع",
    comment: "منتج أنيق وحجمو صغير، والأهم أنو يخدم مع Apple Find My الأصلي بدون أي تطبيق خارجي. يعطيك الصحة."
  }
];
...
export const faqs = [
  {
    ...
    a: "لا مطلقاً! الجهاز يعمل بتقنية البلوتوث والشبكة العالمية (Find My / Google Find Hub) بدون أي شريحة هاتف وبدون أي مصاريف أو اشتراكات شهرية مدى الحياة."
  },
  {
    q: "كيف يحدد الجهاز الموقع إذا ابتعدت عنه؟",
    a: "الجهاز يتواصل بشكل مشفر وآمن مع هواتف أبل أو أندرويد المحيطة به في الشارع أو المواقف، ويرسل لك موقعه المباشر على الخريطة في تطبيقك دون أن يشعر أي أحد."
  },
  {
  ...
  {
    q: "ما هو الفرق بين نسخة الآيفون ونسخة الأندرويد؟",
    a: "نسخة الآيفون مخصصة لهواتف الآيفون والآيباد وتعمل مع تطبيق Apple Find My المدمج. بينما نسخة الأندرويد مخصصة لهواتف أندرويد وتعمل مع شبكة Google Find My Device."
  },
  {
